...
extension IsarTodoQueryFilter
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterFilterCondition> isDoneEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isDone',
...
extension IsarTodoQuerySortBy on QueryBuilder<IsarTodo, IsarTodo, QSortBy> {
  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> sortByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.asc);
    });
  }

  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> sortByIsDoneDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarTodoQuerySortThenBy
  ...
  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> thenByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.asc);
    });
  }

  QueryBuilder<IsarTodo, IsarTodo, QAfterSortBy> thenByIsDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.desc);
    });
  }
...
extension IsarTodoQueryWhereDistinct
  ...
  QueryBuilder<IsarTodo, IsarTodo, QDistinct> distinctByIsDone() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarTodoQueryProperty
  ...
  QueryBuilder<IsarTodo, bool, QQueryOperations> isDoneProperty() {
    return QueryBuilder.apply(this, (query) {
